...
image = canvas.create_image(148, 95, image=filename)
canvas.pack()
...
survey_btn = Button(root, text="TAKE SURVEY", bd=5, fg="white", bg="red", relief=GROOVE, font="Times")
survey_btn.pack()

labelframe = LabelFrame(root, text="Are you an admin? If yes, click the login button below:", bg="black", fg="white")
